...
<body>
    ...
    //Задание 2
    echo"<hr><h3>Задание 2</h3><p><i>".'"Подсчитать количество отрицательных чисел среди чисел а, b, c"'."</i></p>";
    $a = -6;
    $b = 0;
    $c = 100;
    echo "a = $a, b = $b, c = $c</br>";
    ...
    //Задание 3
    echo"<hr><h3>Задание 3</h3><p><i>".'"Дано натуральное число n . Найти сумму первой и последней цифры этого числа."'."</i></p>";
    $a = 3;
    $n = $a;
    if ($n < 10){
